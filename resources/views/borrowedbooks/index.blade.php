            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="p-6 bg-gray-50 rounded-lg shadow-md">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900">{{$book->book->title}}</h3>
                        {{-- <p class="mt-2 text-gray-500">Author: {{$book->book->author->name}}</p> --}}
                        <p class="mt-2 text-gray-500">Genre: {{$book->book->Genre}}</p>
                        <p class="mt-2 text-gray-500">Published: {{$book->book->published}}</p>
