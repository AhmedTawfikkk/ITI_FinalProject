...
<body class="bg-gray-100">
    ...
    <nav class="bg-white shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex">
                    <a href="#" class="flex-shrink-0 flex items-center text-2xl font-bold text-blue-600">OnlineLibrary</a>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="/register" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded transition">Sign Up</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <header class="bg-gradient-to-r from-blue-600 to-blue-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            ...
            <a href="#features" class="mt-8 inline-block bg-white text-blue-600 hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold transition">Learn More</a>
        </div>
    </header>
    ...
    <section id="features" class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center p-6 bg-gray-50 rounded-lg shadow-lg transition-transform transform hover:scale-105">
    ...
    <section id="cta" class="bg-gray-800 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="/register" class="mt-8 inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition">Join Now</a>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <p class="mt-4 text-gray-500">You can email us at <a href="mailto:support@onlinelibrary.com" class="text-blue-600">support@onlinelibrary.com</a></p>
                </div>
                <div class="bg-gray-50 p-6 rounded-lg shadow-md">
